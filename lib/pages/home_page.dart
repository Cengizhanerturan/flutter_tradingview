          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                width: Get.width,
                child: StreamBuilder(
                  stream: _socketController.channel.stream,
                        ...
                        coinMap.entries.forEach((element) {
                          _socketController.coinList.forEach((myMap) {
                            if (myMap.entries.first.key.toString() ==
                              ...
                              var fark =
                                  double.parse(myMap.values.elementAt(0)) -
                                      double.parse(element.value);
                              if (fark < 0) {
                                myMap.update(
                                    myMap.keys.elementAt(1), (value) => "1");
                              } else if (fark > 0) {
                                myMap.update(
                                    myMap.keys.elementAt(1), (value) => "0");
                              } else {
                                myMap.update(
                                    myMap.keys.elementAt(1), (value) => "2");
                              }
                            ...
                            return Padding(
                              ...
                              child: Card(
                                ...
                                child: ListTile(
                                  title: Text(
                                    _socketController
                                        .coinList[index].entries.first.key
                                        .toUpperCase(),
                                    style: ConstantsText.textStyle18WB,
                                  ),
                                  subtitle: Text(
                                    _socketController
                                        .coinList[index].entries.first.value,
